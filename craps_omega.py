...
while num_fichas > 0:
    ...
    while res_jogador == 's' and fase == "Come Out":
        while fase == "Come Out":
            ...
            print('\n Jogando os dados, valor sorteado é de {0} e {1}, e a soma dos valores deu {2}' .format(dado1, dado2, soma_dos_dados))
            dados_em_plb = dado1+dado2
            if pass_line_bet_sn == 'Sim':
                num_fichas, fase, dados_em_plb = lf.pass_line_bet(num_bet_plb,soma_dos_dados,num_fichas)
                print ("Na sua apossta em Pass Line Bet: ")
            if field_sn == 'Sim':
            ...
            if any_craps_sn == 'Sim':
                ...
                print ("Na sua aposta em Any Craps: ")
            if twelve_sn == 'Sim':
        ...
        while fase == "Point":
            ...
            if soma_dos_dados == dados_em_plb or soma_dos_dados == 7:
                ...
                if soma_dos_dados == dados_em_plb:
                    ...
                    print ("Parabéns você ganhou! Agora sua balança é de: {0} fichas\n".format(num_fichas))
                elif soma_dos_dados == 7:
                    num_fichas -= num_bet_plb
                    print ("Oh não você perdeu! Agora sua balança é de: {0} fichas!\n".format(num_fichas))
    if res_jogador == 'n':
